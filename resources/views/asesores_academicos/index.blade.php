@extends('layouts.app')
@section('title', 'Asesores Académicos')
...
<div class="container-fluid p-0">
    ...
    <div class="col-12 bg-primario rounded-top mb-3">
        <div class="col-12 py-4">
            <h1 class="text-white fw-bold text-uppercase text-center fs-4 mb-2">Control de Asesores Académicos</h1>
    ...
    <div class="row w-100 h-100 m-0 p-0">
        ...
        <!-- Header Section -->
        <form action="{{ route('asesores-academicos.index') }}" method="POST"
        ...
        <div class="card shadow-lg my-3 py-3 mx-auto d-lg-none">
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    @if (!$item->activo)
                    <div class="col text-center">
                        <form action="{{ route('asesores-academicos.destroy', $item) }}" method="POST">
                            @csrf
                            @method('DELETE')
