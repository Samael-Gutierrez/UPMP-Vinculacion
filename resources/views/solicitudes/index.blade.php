...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="row w-100 h-100 m-0 p-0">
            ...
            <!-- Header Section -->
            <form action="{{ route('solicitudes.index') }}" method="POST" class="row w-100 p-0 mx-auto align-items-center"
                                    ...
                                    <td class="align-center col-3">
                                        ...
                                        <div class="row justify-content-evenly w-100">
                                            <div class="col text-center px-0">
                                                <a href="{{ route('solicitudes.edit', $item) }}"
                                            ...
                                            <div class="col text-center px-0">
                                                <form action="{{ route('solicitudes.toggle.status', $item) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="hidden" name="activo"
                                                        @if ($item->activo) value="0"
                                            @else
                                                value="1" @endif>

                                                    <button type="submit"
                                                        @if ($item->activo) value="Desactivar"
                                                @else
                                                value="Activar" @endif
                                                        @class([
...
@endif
                                                 ">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                            height="16" fill="currentColor" class="bi bi-toggles2"
                                                            viewBox="0 0 16 16">
                                                            <path
                        ...
                        <div class="row">
                            ...
                            <div class="col text-center">
                                <form action="{{ route('solicitudes.toggle.status', $item) }}" method="POST">
                                    ...
                                    @method('PUT')
                                    <input type="hidden" name="activo"
                                        @if ($item->activo) value="0" @else value="1" @endif>
                                    <input type="submit"
                                        @if ($item->activo) value="Desactivar" @else value="Activar" @endif
                                        @class([
                                ...
                                <div class="col text-center">
                                    <form action="{{ route('solicitudes.destroy', $item) }}" method="POST">
                                        ...
                                        <input type="submit" value="Eliminar"
                                            class="btn btn-sm btn-secundario text-white"
