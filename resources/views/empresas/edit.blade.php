                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-10">
                            ...
                            <div class="form-floating my-2">
                                <input @class(['form-control'=> !$errors->first('nombrecompletouser'), 'form-control
                                is-invalid' => $errors->first('nombrecompletouser')])
                                autocomplete="off"
                                type="text"
                                value="{{ ucfirst(strtolower(Auth::user()->titulo)) . ' ' . Auth::user()->nombre . ' ' . Auth::user()->apellido_paterno . ' ' . Auth::user()->apellido_materno }}"
                                name="nombrecompletouser"
                                placeholder="input-text"
                                id="input-text"
                                readonly>
                                <label for="input-text">Usuario que edita a la empresa </label>
                            </div>

                            <!-- Input Text -->
                            <div class="form-floating my-2">
                                <input onkeyup="mayus(this);" maxlength="12" @class(['form-control'=>
                                !$errors->first('rfc'), 'form-control is-invalid' =>
                                $errors->first('rfc')])
                                autocomplete="off"
                                type="text"
                                value="{{$consulta->rfc }}"
                            ...
                            <div class="form-floating my-2">
                                <input @class(['form-control'=> !$errors->first('nombre'), 'form-control is-invalid' =>
                                $errors->first('nombre')])
                                autocomplete="off"
                                type="text"
                            ...
                            <div class="form-floating my-2">
                                <input @class(['form-control'=> !$errors->first('direccion'), 'form-control is-invalid'
                            ...
                            <div class="form-floating my-2">
                                <input @class(['form-control'=> !$errors->first('ciudad'), 'form-control is-invalid' =>
                                $errors->first('ciudad')])
                                autocomplete="off"
                                type="text"
                            ...
                            <div class="form-floating my-2">
                                <input @class(['form-control'=> !$errors->first('pagina_web'), 'form-control is-invalid'
                            ...
                            <div class="form-floating my-4">
                                <select @class(['form-control form-select'=> !$errors->first('tipo'), 'form-control
                                    ...
                                    @if("Pública" == $consulta->tipo)
                                    <option value="Pública">Pública</option>
                                    <option value="Privada">Privada</option>
                                    @endif
                                    @if("Privada" == $consulta->tipo)
                                    <option value="Privada">Privada</option>
                                    <option value="Pública">Pública</option>
                                    @endif
                            ...
                            <div class="form-floating my-2">
                                <select @class(['form-control form-select'=> !$errors->first('tamaño'), 'form-control
                                    ...
                                    @if("Chica" == $consulta->tamaño)
                                    <option value="Chica">Chica</option>
                                    <option value="Mediana">Mediana</option>
                                    <option value="Grande">Grande</option>
                                    @endif
                                    @if("Mediana" == $consulta->tamaño)
                                    <option value="Mediana">Mediana</option>
                                    <option value="Chica">Chica</option>
                                    <option value="Grande">Grande</option>
                                    @endif
                                    @if("Grande" == $consulta->tamaño)
                                    <option value="Grande">Grande</option>
                                    <option value="Chica">Chica</option>
                                    <option value="Mediana">Mediana</option>
                                    @endif
                            ...
                            <div class="form-check my-2">
                                <div class="row items-center justify-content-center">
                                    ...
                                    <div class="col-6 d-md-flex justify-content-center">
                                        <div>
                                            <input class="form-check-input mx-auto" name="activo" type="radio"
                                                id="opcion-1" value="1" @if($consulta->activo) checked @endif>
                                    ...
                                    <div class="col-6 d-md-flex justify-content-center">
                                        <div>
                                            <input class="form-check-input mx-auto" name="activo" type="radio"
                                                id="opcion-2" value="0" @if(!$consulta->activo) checked @endif>
                            ...
                            <div class="form-floating my-2">
                                <input @class(['form-control'=> !$errors->first('contacto'), 'form-control is-invalid'
                            ...
                            <div class="form-floating my-2">
                                <input @class(['form-control'=> !$errors->first('correo'), 'form-control is-invalid' =>
                                $errors->first('correo')])
                                autocomplete="off"
                                type="text"
                            ...
                            <div class="form-floating my-2">
                                <input @class(['form-control'=> !$errors->first('telefono'), 'form-control is-invalid'
