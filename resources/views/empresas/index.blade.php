...
<div class="container-fluid p-0">
    ...
    <div class="row w-100 h-100 m-0 p-0">
        ...
        <!-- Header Section -->
        <form action="{{ route('empresas.index') }}" method="POST" class="row w-100 p-0 mx-auto align-items-center"
                ...
                <table class="table table-primaria d-none d-lg-table text-center align-center">
                    ...
                    <tbody id="">
                        ...
                        <tr class="d-none d-lg-table-row col-12">
                            ...
                            <td class="col-4">{{ $item->direccion}}</td>
                            <td class="col-1">{{ $item->tipo}}</td>
                            <td class="col-1">{{ $item->tamaño}}</td>
                            <td class="col-1">
                            ...
                            <td class="align-center col-3">
                                ...
                                <div class="row justify-content-evenly w-100">
                                    <div class="col text-center px-0">
                                        <a href="{{ route('empresas.edit', $item) }}"
