...
<div class="container-fluid p-0">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <form action="{{ route('asesores-industriales.update', $consulta) }}" class="form" method="POST">
                @csrf
                ...
                <section id="general-information" class="col-12 col-lg-12" >
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-10">
                            ...
                            <div class="form-floating my-2">
                                <input onkeyup="mayus(this);" maxlength="13"
                                    ...
                                    id="input-text"
                                   >
                                <label for="input-text">RFC del asesor industrial. (EJEM850212KN7)</label>
                                ...
                                <input
                                    ...
                                    id="input-text"
                                   >
                                <label for="input-text">Titulación del asesor industrial</label>
                            ...
                            <div class="form-check my-2">
                                <div class="row items-center justify-content-center">
                                    ...
                                    <div class="col-6 d-md-flex justify-content-center">
                                        <div>
                                            <input class="form-check-input mx-auto" name="activo" type="radio" id="opcion-1" value="1" @if($consulta->activo) checked @endif>
                                    ...
                                    <div class="col-6 d-md-flex justify-content-center">
                                        <div>
                                            <input class="form-check-input mx-auto" name="activo" type="radio" id="opcion-2" value="0" @if(!$consulta->activo) checked @endif>
                            ...
                            <!-- Input Select -->
                            <div class="form-floating my-2">
                                <select name="idem"  id="role_select" class="form-select form-control" autocomplete="off"
                                value="{{ $consulta->idem }}"placeholder="Seleccione una empresa">
                ...
                <div class="d-flex justify-content-end mt-5">
                    <a title="Regresar" href="{{ route('asesores-industriales.index') }}" class="text-end fs-6 text-secundario"><img src="{{ asset('img/regresa.jpg')}}" width="30" height="30"></a>
                </div>
            </form>
            <!-- Form End -->
        </div>
