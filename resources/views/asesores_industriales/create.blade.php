...
<div class="container-fluid p-0">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <!-- Form -->
            <form action="{{ route('asesores-industriales.store') }}" class="form" method="POST">
                @csrf
                @method('POST')
                ...
                <section id="general-information" class="col-12 col-lg-12" >
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-10">
                            ...
                            <div class="form-check my-2">
                                <div class="row items-center justify-content-center">
                                    ...
                                    <div class="col-6 d-md-flex justify-content-center">
                                        <div>
                                            <input class="form-check-input mx-auto" name="activo" type="radio" id="opcion-1" value="1"  checked>
                                    ...
                                    <div class="col-6 d-md-flex justify-content-center">
                                        <div>
                                            <input class="form-check-input mx-auto" name="activo" type="radio" id="opcion-2" value="0" >
                            ...
                            <!-- Input Select -->
                            <div class="form-floating my-2">
                                <select @class(['form-control form-select'=> !$errors->first('idem'), 'form-control
                                    is-invalid' => $errors->first('idem')])
                                    name="idem" class="chosen-select form-control">
                                ...
                                <div class="invalid-feedback">
                                    <i>El campo Empresa es obligatorio</i>
                                </div>
                                @endif
                            </div>
